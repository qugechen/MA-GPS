...
from MAGPS.data import Collector
from MAGPS.policy import BasePolicy
from MAGPS.trainer.base import BaseTrainer
from MAGPS.utils import BaseLogger, LazyLogger
...
class OnpolicyTrainer(BaseTrainer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("bc_weight:", behavior_loss_weight)
        self.behaviour_loss_weight = behavior_loss_weight
    ...
    def policy_update_fn(
        ...
        losses = self.policy.update(
            ...
            behavior_loss_weight=self.behaviour_loss_weight,
        )
